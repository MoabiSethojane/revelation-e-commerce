...
export const Cart = () => {
    ...
    return (
        ...
        <button type="submit" onClick={back} 
                        style={{border: '1px solid transparent', backgroundColor: ' grey', fontSize: '18px', justifyContent: 'center', padding: '1%', width: '20%', color: 'whitesmoke', fontWeight: '500', alignSelf: 'center', marginLeft: '62%', cursor: 'pointer'}}
                        >
